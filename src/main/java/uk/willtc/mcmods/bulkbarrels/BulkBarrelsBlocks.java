...
public class BulkBarrelsBlocks {
    public static final BulkBarrelBlock BULK_BARREL = register("bulk_barrel", BulkBarrelBlock::new, BlockBehaviour.Properties.of(), true);

    public static void initialize() {
    }

    private static <T extends Block> T register(String name, Function<BlockBehaviour.Properties, T> blockFactory, BlockBehaviour.Properties settings, boolean withItem) {
        ...
        T block = Registry.register(BuiltInRegistries.BLOCK, blockKey, blockFactory.apply(settings.setId(blockKey)));
